...
else if(isset($_POST["nom"], $_POST["pass"], $_POST["admin"], $_POST["idProducteur"])) {
    if(isset($_POST["id"])) exit(DBLayer::setUtilisateur(Utilisateur::fromValues($_POST["id"], $_POST["nom"], $_POST["admin"] == "true", $_POST["idProducteur"]), $_POST["pass"])); 
    else exit(DBLayer::addUtilisateur(Utilisateur::fromValues(null, $_POST["nom"], $_POST["admin"] == "true", $_POST["idProducteur"]), $_POST["pass"]));
}
...
<div class="container">
    ...
    <div class="rowtable">
        ...
        <?php foreach(DBLayer::getUtilisateurs() as $u) { ?><div class="row">
            ...
            <div class="col-xs-6 col-sm-3 <?php echo $u->admin ? 'major' : ($u->idProducteur == null ? 'false' : 'true'); ?>"><?php echo $u->admin ? 'Administrateur' : ($u->idProducteur != null ? $u->producteur->nom : 'Aucun'); ?></div>
