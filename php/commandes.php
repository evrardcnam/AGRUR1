...
<div class="container">
    ...
    <div class="rowtable">
        ...
        <?php foreach(DBLayer::getCommandes() as $c) { ?><div class="row">
            <div class="col-xs-6 col-sm-2"><a href="php/client/bdc.php?id=<?php echo $c->num ?>" target="_blank"><span class="glyphicon glyphicon-print"></span></a> <?php echo $c->lot->code; ?></div>
