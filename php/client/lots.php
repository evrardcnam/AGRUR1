...
<div class="container">
    ...
    <div class="rowtable">
        ...
        <?php foreach(DBLayer::getLotsStock() as $l) {
            ...
            <div class="col-xs-4 col-sm-2" style="text-align:right"><a class="sliderPage" data-link="php/client/comLot.php?id=<?php echo $l->id; ?>"><button type="button" class="btn btn-warning">Détails</button></a></div>
        </div><?php } ?>
    </div>
</div>